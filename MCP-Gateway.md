...
Each criterion must be **quantifiable** or **scorable** on the 0–3 scale defined in the [Scoring Methodology](#scoring-methodology). The evaluation should produce a specific score (0, 1, 2, or 3) based on observable evidence, not subjective judgment.
